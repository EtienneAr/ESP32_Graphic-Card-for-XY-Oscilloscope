...
size_t GO_drawPoint_len        ( int x, int y, int intensisty);

void   GO_drawLine(void* start, int x1, int y1, int x2, int y2, int spacing, int intensisty);
size_t GO_drawLine_len        ( int x1, int y1, int x2, int y2, int spacing, int intensisty);

/*
void   GO_drawRect(void* start, int x1, int y1, int x2, int y2, Pen_t pen);
size_t GO_drawRect_len        ( int x1, int y1, int x2, int y2, Pen_t pen);

void   GO_drawArc(void* start, int x, int y, float r, float a1, float a2, Pen_t pen);
size_t GO_drawArc_len        ( int x, int y, float r, float a1, float a2, Pen_t pen);
*/
#endif
...
size_t GO_drawChar(void* start, char c, float x, float y, float height, int intensity) {
	...
	switch(c) {
		case 'Z':
			...
			size += GO_drawLine(SAFE_PTR(start, size), x+2*height_factor, y+7*height_factor, x+0*height_factor, y+3*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+3*height_factor, x+2*height_factor, y+3*height_factor, 1, intensity);
			break;
		case 'Y':
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+7*height_factor, x+1*height_factor, y+5*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+1*height_factor, y+5*height_factor, x+2*height_factor, y+7*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+1*height_factor, y+5*height_factor, x+1*height_factor, y+3*height_factor, 1, intensity);
			break;
		case 'X':
		...
		case 'W':
			...
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+3*height_factor, x+1*height_factor, y+4*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+1*height_factor, y+4*height_factor, x+2*height_factor, y+3*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+2*height_factor, y+3*height_factor, x+2*height_factor, y+7*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+1*height_factor, y+4*height_factor, x+1*height_factor, y+7*height_factor, 1, intensity);
			break;
		case 'V':
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+7*height_factor, x+1*height_factor, y+3*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+1*height_factor, y+3*height_factor, x+2*height_factor, y+7*height_factor, 1, intensity);
			break;
		case 'U':
			...
			size += GO_drawLine(SAFE_PTR(start, size), x+1*height_factor, y+3*height_factor, x+2*height_factor, y+4*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+2*height_factor, y+4*height_factor, x+2*height_factor, y+7*height_factor, 1, intensity);
			break;
		case 'T':
		...
		case 'S':
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+4*height_factor, x+1*height_factor, y+3*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+1*height_factor, y+3*height_factor, x+2*height_factor, y+4*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+2*height_factor, y+4*height_factor, x+0*height_factor, y+6*height_factor, 1, intensity);
		...
		case 'R':
			...
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+7*height_factor, x+1*height_factor, y+7*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+1*height_factor, y+7*height_factor, x+2*height_factor, y+6*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+2*height_factor, y+6*height_factor, x+1*height_factor, y+5*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+1*height_factor, y+5*height_factor, x+0*height_factor, y+5*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+1*height_factor, y+5*height_factor, x+2*height_factor, y+3*height_factor, 1, intensity);
			break;
		case 'Q':
		...
		case 'K':
			...
			size += GO_drawLine(SAFE_PTR(start, size), x+2*height_factor, y+6*height_factor, x+2*height_factor, y+7*height_factor, 1, intensity);
		...
		case 'G':
			...
			size += GO_drawLine(SAFE_PTR(start, size), x+2*height_factor, y+5*height_factor, x+2*height_factor, y+4*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+2*height_factor, y+4*height_factor, x+1*height_factor, y+3*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+1*height_factor, y+3*height_factor, x+0*height_factor, y+4*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+4*height_factor, x+0*height_factor, y+6*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+6*height_factor, x+1*height_factor, y+7*height_factor, 1, intensity);
		...
		case 'F':
			...
			break;
		case 'E':
			size += GO_drawLine(SAFE_PTR(start, size), x+2*height_factor, y+3*height_factor, x+0*height_factor, y+3*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+3*height_factor, x+0*height_factor, y+7*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+7*height_factor, x+2*height_factor, y+7*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+5*height_factor, x+1*height_factor, y+5*height_factor, 1, intensity);
			break;
		case 'D':
			...
			size += GO_drawLine(SAFE_PTR(start, size), x+1*height_factor, y+3*height_factor, x+2*height_factor, y+4*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+2*height_factor, y+4*height_factor, x+2*height_factor, y+6*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+2*height_factor, y+6*height_factor, x+1*height_factor, y+7*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+1*height_factor, y+7*height_factor, x+0*height_factor, y+7*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+7*height_factor, x+0*height_factor, y+3*height_factor, 1, intensity);
			break;
		case 'C':
			size += GO_drawLine(SAFE_PTR(start, size), x+2*height_factor, y+4*height_factor, x+1*height_factor, y+3*height_factor, 1, intensity);
		...
		case 'B':
			...
			break;
		case 'A':
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+3*height_factor, x+0*height_factor, y+6*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+6*height_factor, x+0*height_factor, y+7*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+7*height_factor, x+2*height_factor, y+6*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+2*height_factor, y+6*height_factor, x+2*height_factor, y+3*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+2*height_factor, y+5*height_factor, x+0*height_factor, y+5*height_factor, 1, intensity);
			break;
		case '/':
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+3*height_factor, x+2*height_factor, y+7*height_factor, 1, intensity);
			break;
		...
		case '|':
			...
			break;
		case '?':
			size += GO_drawLine(SAFE_PTR(start, size), x+1*height_factor, y+3*height_factor, x+1*height_factor, y+4*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+1*height_factor, y+5*height_factor, x+2*height_factor, y+6*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+2*height_factor, y+6*height_factor, x+2*height_factor, y+7*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+2*height_factor, y+7*height_factor, x+0*height_factor, y+7*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+7*height_factor, x+0*height_factor, y+6*height_factor, 1, intensity);
			break;
		case '!':
			size += GO_drawLine(SAFE_PTR(start, size), x+1*height_factor, y+4*height_factor, x+1*height_factor, y+3*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+1*height_factor, y+7*height_factor, x+1*height_factor, y+5*height_factor, 1, intensity);
			break;
		case ':':
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+5*height_factor, x+1*height_factor, y+5*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+3*height_factor, x+1*height_factor, y+3*height_factor, 1, intensity);
		...
		case '9':
			size += GO_drawLine(SAFE_PTR(start, size), x+2*height_factor, y+5*height_factor, x+0*height_factor, y+5*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+5*height_factor, x+0*height_factor, y+7*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+7*height_factor, x+2*height_factor, y+7*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+2*height_factor, y+7*height_factor, x+2*height_factor, y+3*height_factor, 1, intensity);
			break;
		case '8':
		...
		case '2':
			...
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+4*height_factor, x+0*height_factor, y+3*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+3*height_factor, x+2*height_factor, y+3*height_factor, 1, intensity);
			break;
		case '1':
			size += GO_drawLine(SAFE_PTR(start, size), x+1*height_factor, y+7*height_factor, x+1*height_factor, y+3*height_factor, 1, intensity);
		...
		case 'z':
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+5*height_factor, x+2*height_factor, y+5*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+2*height_factor, y+5*height_factor, x+0*height_factor, y+3*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+3*height_factor, x+2*height_factor, y+3*height_factor, 1, intensity);
			break;
		case 'y':
			...
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+1*height_factor, x+0*height_factor, y+-26*height_factor, 1, intensity);
			break;
		case 'x':
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+3*height_factor, x+2*height_factor, y+5*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+5*height_factor, x+2*height_factor, y+3*height_factor, 1, intensity);
			break;
		case 'w':
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+5*height_factor, x+0*height_factor, y+3*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+3*height_factor, x+2*height_factor, y+3*height_factor, 1, intensity);
		...
		case 't':
			...
			size += GO_drawLine(SAFE_PTR(start, size), x+1*height_factor, y+3*height_factor, x+1*height_factor, y+6*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+5*height_factor, x+2*height_factor, y+5*height_factor, 1, intensity);
			break;
		case 's':
			size += GO_drawLine(SAFE_PTR(start, size), x+2*height_factor, y+5*height_factor, x+0*height_factor, y+5*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+5*height_factor, x+0*height_factor, y+4*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+4*height_factor, x+2*height_factor, y+4*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+2*height_factor, y+4*height_factor, x+2*height_factor, y+3*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+2*height_factor, y+3*height_factor, x+0*height_factor, y+3*height_factor, 1, intensity);
			break;
		case 'a':
		...
		case 'e':
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+4*height_factor, x+2*height_factor, y+4*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+2*height_factor, y+4*height_factor, x+2*height_factor, y+5*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+2*height_factor, y+5*height_factor, x+0*height_factor, y+5*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+5*height_factor, x+0*height_factor, y+3*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+3*height_factor, x+2*height_factor, y+3*height_factor, 1, intensity);
			break;
		case 'f':
			...
			break;
		case 'g':
			size += GO_drawLine(SAFE_PTR(start, size), x+2*height_factor, y+4*height_factor, x+0*height_factor, y+3*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+3*height_factor, x+0*height_factor, y+5*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+5*height_factor, x+2*height_factor, y+5*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+2*height_factor, y+5*height_factor, x+2*height_factor, y+1*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+2*height_factor, y+1*height_factor, x+0*height_factor, y+1*height_factor, 1, intensity);
			break;
		case 'h':
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+7*height_factor, x+0*height_factor, y+3*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+5*height_factor, x+2*height_factor, y+5*height_factor, 1, intensity);
			...
			break;
		case 'i':
			size += GO_drawLine(SAFE_PTR(start, size), x+1*height_factor, y+3*height_factor, x+1*height_factor, y+5*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+1*height_factor, y+6*height_factor, x+2*height_factor, y+7*height_factor, 1, intensity);
			break;
		case 'j':
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+1*height_factor, x+1*height_factor, y+2*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+1*height_factor, y+2*height_factor, x+1*height_factor, y+5*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+1*height_factor, y+6*height_factor, x+2*height_factor, y+7*height_factor, 1, intensity);
			break;
		case 'k':
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+7*height_factor, x+0*height_factor, y+3*height_factor, 1, intensity);
		...
		case '*':
			...
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+6*height_factor, x+2*height_factor, y+4*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+5*height_factor, x+2*height_factor, y+5*height_factor, 1, intensity);
			size += GO_drawLine(SAFE_PTR(start, size), x+1*height_factor, y+6*height_factor, x+1*height_factor, y+4*height_factor, 1, intensity);
			break;
		case '_':
			size += GO_drawLine(SAFE_PTR(start, size), x+0*height_factor, y+1*height_factor, x+2*height_factor, y+1*height_factor, 1, intensity);
			break;
		default:
